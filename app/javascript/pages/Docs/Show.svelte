...
<div class="min-h-screen text-white">
  <div class="max-w-6xl mx-auto px-6 py-8">
    ...
    <!-- Edit on GitHub -->
    <div class="flex items-center justify-center gap-2 py-6 text-sm text-secondary/70">
