<script lang="ts">
  ...
  const PROSE_CLASS = `bg-dark rounded-lg p-4 sm:p-6 lg:p-8 mb-8 prose prose-invert prose-base sm:prose-lg max-w-none
...
<div class="min-h-screen text-surface-content">
  <div class="w-full max-w-5xl mx-auto px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
    ...
    <div class={PROSE_CLASS}>{@html rendered_content}</div>
