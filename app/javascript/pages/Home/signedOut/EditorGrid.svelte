<script lang="ts">
  ...
  const editors = [
    ...
    { name: "JetBrains", slug: "intellij-idea" },
    { name: "Vim", slug: "vim" },
    { name: "Neovim", slug: "neovim" },
    { name: "Sublime", slug: "sublime-text" },
...
<section class="py-20 w-full bg-surface-100" id="integrations">
  <div class="max-w-[1100px] mx-auto px-6 text-center">
    ...
    <p class="text-secondary mx-auto max-w-[60ch] text-lg mb-12">
      Hackatime uses the open-source WakaTime plugin ecosystem. If your editor
    ...
    <div class="flex flex-wrap justify-center gap-12 max-w-[800px] mx-auto">
      ...
      >
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 text-secondary group-hover:text-primary transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v12m6-6H6" />
          </svg>
        </div>
        <span class="text-xs font-medium text-secondary group-hover:text-primary transition-colors">More</span>
      </a>
    </div>
  </div>
</section>
