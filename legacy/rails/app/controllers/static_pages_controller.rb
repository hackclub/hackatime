class StaticPagesController < InertiaController
  ...
  def wakatime_alternative
    @meta_description = @og_description = @twitter_description = "Looking for a WakaTime alternative? Hackatime is a free, open source coding time tracker with all features unlocked. Compare features and pricing to see why developers are switching."
